  ...
  return (
    <Card style={{ marginBottom: 24 }}>
      <Descriptions title="Account Information" bordered column={1}>
        ...
        <Descriptions.Item span={2} label="Date of Birth">{userDetails.dob ?? '--'}</Descriptions.Item>
        <Descriptions.Item span={2} label="Time of Birth, Place of Birth">{userDetails.description ?? '--'}</Descriptions.Item>
