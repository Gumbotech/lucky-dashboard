...
import { getMonthsBetween, isDateWithinRange } from '../../../utils/utils';
...
export default function UserDetailsPage({ configData, user }) {
  ...
  const handleDateSelect = (date) => {
    ...
    if (user?.calendarStatusData?.endTime && isDateWithinRange(luxonDate, user.calendarStatusData.endTime)) {
      ...
      // Handle the case where endTime is undefined or is not within the range
      console.log("Invalid or out-of-range endTime:", user?.calendarStatusData?.endTime);
    }
